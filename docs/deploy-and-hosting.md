...
- **Dodatkowe domeny:** skonfiguruj w panelu hostingu lub rejestratora **przekierowanie 301** na kanoniczny adres `https://orthomedica.lubin.pl` (zgodny z `site` w `astro.config.mjs`), żeby uniknąć duplikacji treści w indeksie wyszukiwarki.
