export const cennikTabs = [
  {
    ...
    type: "cards",
    intro:
      "Niewidoczne nakładki prostujące zęby — zdejmujesz do jedzenia, nikt nie wie że je nosisz. Cena obejmuje całe leczenie łącznie z wizytami kontrolnymi.",
    items: [
      {
    ...
    freeItem: {
      name: "Konsultacja + skan iTero 3D",
      desc: "Cyfrowe wyciski i symulacja uśmiechu na miejscu — bez zobowiązań",
      price: "Bezpłatnie",
    },
  },
  {
    ...
    type: "cards",
    intro:
      "Ceny podane są za jeden łuk (górny lub dolny). Do kosztu aparatu dochodzą wizyty kontrolne co 6–8 tygodni.",
    items: [
      {
      ...
      {
        name: "Konsultacja z diagnostyką",
        desc: "Analiza skanów / wycisków, RTG, fotografie",
        price: "od 400 zł",
        unit: "jednorazowo",
      },
    ],
    infoBox: {
      title: "Ile kosztuje leczenie łącznie?",
      content:
        "Aparat metalowy na oba łuki (18 miesięcy, wizyty co 7 tygodni) to ok. 6 000 zł za aparaty + ~10 wizyt × 350 zł = łącznie ok. 9 500 – 11 000 zł. Dokładny plan kosztów otrzymasz na konsultacji.",
    },
  },
  {
    id: "dzieci",
  ...
  },
  {
    ...
    type: "cards",
    intro:
      "Retencja to obowiązkowy, ostatni etap każdego leczenia. Bez niej zęby wracają na poprzednie pozycje. Koszt retencji wliczamy z góry do planu leczenia.",
    items: [
      {
  ...
  },
  {
    ...
    type: "cards",
    intro:
      "Badania diagnostyczne wymagane do zaplanowania leczenia. RTG panoramiczne i skan 3D to standard przed każdym aparatem stałym lub nakładkami.",
    items: [
      {
        name: "RTG punktowe",
  ...
  },
  {
    ...
    type: "cards",
    intro:
      "Przed założeniem aparatu wymagany jest idealny stan zębów. Wszystkie zabiegi higieniczne wykonujemy w klinice — nie musisz szukać dodatkowego gabinetu.",
    items: [
      {
        name: "Scaling + piaskowanie + polerowanie + fluoryzacja",
        desc: "Kompleksowe oczyszczenie — wymagane przed aparatem",
        price: "od 400 zł",
        unit: "oba łuki",
        tag: "Wymagane przed leczeniem",
      },
      {
  ...
  },
  {
    ...
    type: "groups",
    intro:
      "Uzupełniamy braki wymagane do leczenia ortodontycznego oraz zapewniamy kompleksową opiekę stomatologiczną w jednym miejscu.",
    groups: [
      {
      ...
      {
        groupName: "Leczenie kanałowe (endodoncja)",
        items: [
